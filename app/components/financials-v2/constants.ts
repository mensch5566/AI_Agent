...
export const IS_ROWS: MetricSpec[] = [
  ...
  { key: "restructuring_charges", label: "Restructuring & Impairments", kind: "core" },
  ...
  { key: "gain_loss_on_equity_investments", label: "Gain (Loss) on Equity Investments", kind: "core", indent: 1 },
  ...
  { key: "equity_method_investments", label: "Equity in Net Income of Investees", kind: "core", indent: 1 },
  ...
  { key: "net_income_total_pre_nci", label: "Net Income (pre-NCI)", kind: "core" },
  { key: "net_income_nci", label: "Less: Net Income attrib. to NCI", kind: "core", indent: 1 },
...
export const BS_ROWS: MetricSpec[] = [
  ...
  { key: "current_debt", label: "Current Debt", kind: "core" },
  { key: "operating_lease_current", label: "ST Lease Obligations", kind: "core" },
